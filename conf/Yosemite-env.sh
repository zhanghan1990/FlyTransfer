...
# This file contains environment variables required to run Yosemite. Copy it as
# Yosemite-env.sh and edit that to configure Varys for your site. At a minimum,
...
Yosemite_SLAVE_IP=127.0.0.1
Yosemite_SLAVE_PORT=22223