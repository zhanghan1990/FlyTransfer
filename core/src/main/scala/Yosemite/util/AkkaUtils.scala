...
private[Yosemite] object AkkaUtils {
        ...
        actor {
          ...
          kryo {
            ...
            classes = [
              ...
              "Yosemite.framework.Heartbeat",
              "Yosemite.framework.RegisteredSlave",
              "Yosemite.framework.RegisterSlaveFailed",
              "Yosemite.framework.RegisterClient",
              "Yosemite.framework.RegisterCoflow",
              "Yosemite.framework.RegisterCoflowFailed",
              "Yosemite.framework.RejectedCoflow",
              "Yosemite.framework.UnregisterCoflow",
              "Yosemite.framework.RequestBestRxMachines",
              "Yosemite.framework.RequestBestTxMachines",
              "Yosemite.framework.RegisteredClient",
              "Yosemite.framework.CoflowKilled",
              "Yosemite.framework.RegisterClientFailed",
              "Yosemite.framework.RegisteredCoflow",
              "Yosemite.framework.UnregisteredCoflow",
              "Yosemite.framework.BestRxMachines",
              "Yosemite.framework.BestTxMachines",
              "Yosemite.framework.UpdatedRates",
              "Yosemite.framework.AddFlow",
              "Yosemite.framework.AddFlows",
              "Yosemite.framework.GetFlow",
              "Yosemite.framework.GetFlows",
              "Yosemite.framework.FlowProgress",
              "Yosemite.framework.DeleteFlow",
              "Yosemite.framework.GotFlowDesc",
              "Yosemite.framework.GotFlowDescs",
              "Yosemite.framework.CoflowDescription",
              "Yosemite.framework.CoflowType$",
              "Yosemite.framework.FlowDescription",
              "Yosemite.framework.FileDescription",
              "Yosemite.framework.ObjectDescription",
   ...
   * throw a YosemiteException if this fails.
   */
