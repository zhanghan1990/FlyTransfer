...
private[Yosemite] class BpsInfo {

  // TODO: Might need a lock before updates and reads
  
  val HEARTBEAT_SEC = System.getProperty("Yosemite.framework.heartbeat", "1").toInt
  val OLD_FACTOR = System.getProperty("Yosemite.network.oldFactor", "0.2").toDouble
  val NIC_BPS = System.getProperty("Yosemite.network.nicMbps", "1024").toDouble * 1024.0 * 1024.0
