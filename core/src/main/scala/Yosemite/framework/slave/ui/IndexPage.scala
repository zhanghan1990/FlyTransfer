...
import Yosemite.framework.{JsonProtocol, RequestSlaveState, SlaveState}
import Yosemite.ui.UIUtils

import scala.concurrent.Await
import scala.concurrent.duration._
import scala.xml.Node
private[Yosemite] class IndexPage(parent: SlaveWebUI) {
    ...
    val content =
      <div class="row-fluid">
        ...
        <div class="span12">
          <ul class="unstyled">
            <li>
              <strong>ID:</strong>{slaveState.slaveId}
            </li>
            <li>
              <strong>
            ...
            <li>
              <strong>RxBps:</strong>{slaveState.rxBps}
            </li>
            <li>
              <strong>TxBps:</strong>{slaveState.txBps}
            </li>
          </ul>
          <p>
            <a href={slaveState.masterWebUiUrl}>Back to Master</a>
          </p>
        </div>
      </div>

    UIUtils.basicVarysPage(content, "Yosemite Slave at %s:%s".format(
